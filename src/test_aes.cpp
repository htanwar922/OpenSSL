...
// 	0xee, 0xff, 0x00, 0x00, 0x06, 0x5f, 0x1f, 0x04,
...
int main(int argc, char ** argv)
{
	...
	AES aes(ALGORITHM, key, sizeof(key), iv, sizeof(iv));
	size_t ciphertext_len = aes.Encrypt(plaintext, plaintext_len, ciphertext);
	size_t decodedtext_len = aes.Decrypt(ciphertext, ciphertext_len, decodedtext);
